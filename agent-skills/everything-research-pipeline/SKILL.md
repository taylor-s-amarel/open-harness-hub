---
name: everything-research-pipeline
description: 'Given a research query, run it through every supported pre/post-API
  pass: redact, guard, expand, classify, decompose, multi-query, sanitize, retrieve
  (BM25+dense+RRF), rerank, citation-graph expand, persona, framework-select, schema-inject,
  context-pack, compress, gate, LLM call, parse, hallucination-score, official-source
  verify, schema-validate, iterative-revise, audit, deliver.'
...
- **knowledge_packs**: `knowledge-pack/common-abbreviations`, `knowledge-pack/iso-country-codes`, `knowledge-pack/owasp-top-10-llm`
- **rule_packs**: `rule-pack/privacy-pii-text-en`, `rule-pack/grep-ai-vendor-keys`, `rule-pack/grep-prompt-injection-heuristics`, `rule-pack/web-search-allowlist-default`, `rule-pack/hybrid-retrieval-policy`
