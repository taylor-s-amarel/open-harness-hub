---
name: audio-mel-spec-cnn-classifier
description: Convert audio to mel-spectrograms, train CNN backbone, classify.
...
- Hub artifact: `pipeline/audio-mel-spec-cnn-classifier` v0.1.0
- License: `MIT`
